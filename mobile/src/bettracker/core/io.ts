...
/**
 * Writes an export to a cache file and hands it to the system share sheet.
 *
 * A phone has no download folder to drop a file into, so "export" means
 * handing the file to whatever the user wants to keep it in — Drive, Files,
 * a mail draft. The file goes to the cache directory because the copy the
 * share sheet takes is the one that matters; ours is disposable.
 */
 ...
 * The counterpart of `exportFile` for restoring a backup or importing a CSV.
 */
