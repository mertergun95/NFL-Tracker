...
export const STAT_LABELS: Record<string, string> = {
  ...
  rec_long: "En Uzun Rec",
  first_downs: "İlk Down",
  total_yards: "Toplam Yd",
  rushing_attempts: "Koşu Denemesi",
  yards_per_pass: "Yd/Pas",
  yards_per_rush: "Yd/Koşu",
  third_down_pct: "3. Down %",
  points: "Sayı",
  points_allowed: "Yenilen",
  points_pg: "Sayı/Maç",
  points_allowed_pg: "Yenilen/Maç",
  total_yards_pg: "Yd/Maç",
  passing_yards_pg: "Pas Yd/Maç",
  rushing_yards_pg: "Koşu Yd/Maç",
  turnovers_pg: "TO/Maç",
  third_down_pct_pg: "3. Down %",
  conf_wins: "Konf G",
  conf_losses: "Konf M",
